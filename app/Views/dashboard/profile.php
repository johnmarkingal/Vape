    ...
    <div class="dashboard-container" style="display: flex; flex-grow: 1;">
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="<?= site_url('dashboard/settings') ?>"><i class="fas fa-cog"></i> Settings</a></li>
        ...
        <main class="main-content">
            <div class="container">
                ...
                <a href="<?= site_url('dashboard/edit-profile') ?>" class="action-btn">Edit Profile</a>
            </div>
        </main>
    </div>
</body>
