...
<head>
    ...
    <title>Vape Shop - Stock In List</title>
...
<body>
    ...
    <div class="dashboard-container" style="display: flex; flex-grow: 1;">
        ...
        <main class="main-content">
            <header>
                <h1>Stock In List</h1>
                <a href="<?= site_url('stock_in/create') ?>" class="action-btn">Add Stock In</a>
            </header>
                    ...
                    <tbody>
                        <?php foreach ($stock_in as $stock): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('stock_in/edit/' . $stock['id']) ?>" class="btn-edit">Edit</a>
                                    <a href="<?= site_url('stock_in/delete/' . $stock['id']) ?>" class="btn-delete" onclick="return confirm('Are you sure?')">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
